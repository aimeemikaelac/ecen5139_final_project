...
struct runQueue : public sc_module {
    ...
    sc_signal< sc_lv<32> > j_1_fu_204_p2;
    sc_signal< sc_lv<32> > j_1_reg_289;
    sc_signal< sc_lv<32> > i_fu_213_p2;
    sc_signal< sc_lv<32> > i_reg_297;
    sc_signal< sc_lv<32> > i_1_fu_227_p2;
    sc_signal< sc_lv<32> > j_reg_146;
    sc_signal< sc_lv<1> > localEmpty_load_load_fu_224_p1;
    sc_signal< sc_lv<32> > val_assign_reg_158;
    sc_signal< sc_lv<32> > op2_assign_reg_169;
    sc_signal< sc_lv<32> > result_fu_70;
    sc_signal< sc_lv<32> > result_1_s_fu_249_p3;
    sc_signal< sc_lv<1> > tmp_fu_199_p2;
    sc_signal< sc_lv<1> > localFull_fu_74;
    sc_signal< sc_lv<1> > grp_read_fu_111_p2;
    sc_signal< sc_lv<1> > localFull_load_load_fu_210_p1;
    sc_signal< sc_lv<1> > localEmpty_fu_78;
    sc_signal< sc_lv<1> > grp_read_fu_133_p2;
    sc_signal< sc_lv<2> > cmdOut_V_preg;
    sc_signal< sc_lv<32> > currentIteration_preg;
    sc_signal< sc_lv<4> > tmp_1_fu_219_p1;
    sc_signal< sc_lv<4> > priorityOut_V_preg;
    sc_signal< sc_logic > fullOut_preg;
    sc_signal< sc_lv<32> > tmp_4_fu_233_p1;
    sc_signal< sc_lv<1> > tmp_5_fu_237_p2;
    sc_signal< sc_lv<32> > result_1_fu_243_p2;
    ...
    void thread_fullOut();
    void thread_grp_read_fu_111_p2();
    void thread_grp_read_fu_133_p2();
    ...
    void thread_localEmpty_load_load_fu_224_p1();
    void thread_localFull_load_load_fu_210_p1();
    void thread_priorityOut_V();
    void thread_result_1_fu_243_p2();
    void thread_result_1_s_fu_249_p3();
    void thread_tmp_1_fu_219_p1();
    void thread_tmp_4_fu_233_p1();
