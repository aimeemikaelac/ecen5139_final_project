...
struct runQueue : public sc_module {
    ...
    sc_signal< sc_lv<1> > grp_load_fu_342_p1;
    sc_signal< sc_lv<1> > localFull_load_reg_456;
    sc_signal< sc_lv<1> > grp_load_fu_350_p1;
    sc_signal< sc_lv<1> > localEmpty_load_reg_460;
    sc_signal< sc_lv<1> > result_1_s_fu_369_p2;
    sc_signal< sc_lv<32> > i_s_fu_375_p2;
    sc_signal< sc_lv<1> > localFull_load_1_reg_478;
    sc_signal< sc_lv<32> > i_1_fu_381_p2;
    sc_signal< sc_lv<32> > i_1_reg_485;
    sc_signal< sc_lv<1> > localEmpty_load_2_reg_495;
    sc_signal< sc_lv<4> > priorityIn_V_read_1_reg_499;
    sc_signal< sc_lv<1> > p_result_s_fu_408_p2;
    sc_signal< sc_lv<1> > tmp7_fu_414_p2;
    sc_signal< sc_lv<1> > tmp7_reg_512;
    sc_signal< sc_lv<32> > j_s_fu_419_p2;
    sc_signal< sc_lv<32> > j_s_reg_516;
    sc_signal< sc_lv<32> > i_fu_425_p2;
    sc_signal< sc_lv<1> > result_3_reg2mem_reg_273;
    sc_signal< sc_lv<1> > result_reg2mem_1_reg_177;
    sc_signal< sc_lv<1> > result_reg2mem_0_ph_reg_286;
    sc_signal< sc_lv<32> > j_1_reg2mem_1_reg_191;
    sc_signal< sc_lv<32> > j_1_reg2mem_0_ph_reg_300;
    sc_signal< sc_lv<32> > op2_assign_reg2mem_reg_206;
    sc_signal< sc_lv<1> > result_1_reg2mem_reg_217;
    sc_signal< sc_lv<32> > i_1_reg2mem_reg_227;
    sc_signal< sc_lv<1> > result_1_reg2mem_1_reg_240;
    sc_signal< sc_lv<32> > i_3_reg2mem_reg_251;
    sc_signal< sc_lv<1> > p_result_3_reg2mem_reg_262;
    sc_signal< sc_lv<32> > i_reg2mem_reg_313;
    sc_signal< sc_lv<1> > result_reg2mem_2_reg_324;
    sc_signal< sc_lv<1> > tmp_fu_353_p2;
    sc_signal< sc_lv<64> > tmp_s_fu_387_p1;
    sc_signal< sc_lv<1> > localFull_fu_90;
    sc_signal< sc_lv<1> > grp_read_fu_112_p2;
    sc_signal< sc_lv<1> > localEmpty_fu_94;
    sc_signal< sc_lv<1> > grp_read_fu_135_p2;
    sc_signal< sc_lv<2> > cmdOut_V_preg;
    sc_signal< sc_lv<32> > currentIteration_preg;
    sc_signal< sc_lv<4> > priorityOut_V_preg;
    sc_signal< sc_lv<4> > tmp_1_fu_392_p1;
    sc_signal< sc_lv<4> > tmp_2_fu_431_p1;
    sc_signal< sc_logic > fullOut_preg;
    sc_signal< sc_lv<32> > tmp_3_fu_359_p1;
    sc_signal< sc_lv<1> > tmp_4_fu_363_p2;
    sc_signal< sc_lv<1> > ult_fu_397_p2;
    ...
    void thread_fullOut();
    void thread_grp_load_fu_342_p1();
    void thread_grp_load_fu_350_p1();
    void thread_grp_read_fu_112_p2();
    void thread_grp_read_fu_135_p2();
