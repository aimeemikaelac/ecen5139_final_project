...
define i1 @runQueue(i4* %priorityOut_V, i4* %priorityIn_V, i2* %cmdOut_V, i1* %empty, i1* %full, i1* %fullOut, i32 %iterations, i1* %finished, i32* %currentIteration) {
  ...
  br i1 %tmp, label %1, label %.loopexit98
...
; <label>:2                                       ; preds = %.loopexit
  call void @_ssdm_op_Write.ap_none.i32P(i32* %currentIteration, i32 %j_1_reg2mem_1)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %currentIteration, [1 x i8]* @p_str1, [10 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
  ...
  br i1 %localFull_load_3, label %.preheader, label %5

; <label>:3                                       ; preds = %6
  call void @_ssdm_op_Write.ap_none.volatile.i2P(i2* %cmdOut_V, i2 1)
  %tmp_2 = trunc i32 %i_reg2mem to i4
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %priorityOut_V, i4 %tmp_2)
  br label %6
...
; <label>:6                                       ; preds = %.preheader99, %3
  ...
  br i1 %localFull_load_4, label %.preheader, label %3
...
.preheader:                                       ; preds = %1, %6, %2
  ...
  br i1 %localEmpty_load, label %.loopexit97, label %7
...
; <label>:9                                       ; preds = %8, %7
  ...
  br i1 %localEmpty_load_1, label %.loopexit97, label %8
...
.loopexit97:                                      ; preds = %9, %.preheader
  ...
  br i1 %localFull_load_1, label %.loopexit96, label %10
...
; <label>:12                                      ; preds = %11, %10
  ...
  br i1 %localFull_load_2, label %.loopexit96, label %11
...
; <label>:13                                      ; preds = %.loopexit96
  call void @_ssdm_op_Write.ap_none.volatile.i2P(i2* %cmdOut_V, i2 -2)
  %priorityIn_V_load_178 = call i4 @_ssdm_op_Read.ap_none.volatile.i4P(i4* %priorityIn_V)
  br label %15
...
.loopexit:                                        ; preds = %15, %.loopexit96
  %result_3_reg2mem = phi i1 [ %result_1_reg2mem_1, %.loopexit96 ], [ %p_result_3_reg2mem, %15 ]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind
  call void @_ssdm_op_Write.ap_none.volatile.i2P(i2* %cmdOut_V, i2 0)
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind
  %tmp7 = icmp slt i32 %j_1_reg2mem_1, %iterations_read
  %j_s = add nsw i32 %j_1_reg2mem_1, 1
  br i1 %tmp7, label %2, label %.loopexit98
