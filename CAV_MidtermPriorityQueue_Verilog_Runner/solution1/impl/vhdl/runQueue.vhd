...
architecture behav of runQueue is 
    ...
    "runQueue,hls_ip_2014_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.015000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}";
    ...
    signal j_1_reg_333 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_244_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_reg_341 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_250_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_reg_346 : STD_LOGIC_VECTOR (7 downto 0);
    signal localFull_load_load_fu_241_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_5_reg_359 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal result_1_fu_288_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_read_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_6_fu_284_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st9_fsm_8 = ap_CS_fsm) or ((ap_ST_st10_fsm_9 = ap_CS_fsm) and (ap_const_lv1_0 = localEmpty_load_load_fu_265_p1)))) then 
                    cmdOut_V_preg <= ap_const_lv2_2;
                elsif ((((ap_ST_st4_fsm_3 = ap_CS_fsm) and (localFull_load_load_fu_241_p1 = ap_const_lv1_0)) or (ap_ST_st3_fsm_2 = ap_CS_fsm))) then 
                    cmdOut_V_preg <= ap_const_lv2_1;
                elsif ((((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_58)) or ((ap_ST_st10_fsm_9 = ap_CS_fsm) and not((ap_const_lv1_0 = localEmpty_load_load_fu_265_p1))) or ((ap_ST_st2_fsm_1 = ap_CS_fsm) and not((ap_const_lv1_0 = tmp_fu_230_p2))) or ((ap_ST_st4_fsm_3 = ap_CS_fsm) and not((localFull_load_load_fu_241_p1 = ap_const_lv1_0))) or (ap_ST_st7_fsm_6 = ap_CS_fsm) or (ap_ST_st13_fsm_12 = ap_CS_fsm))) then 
                    cmdOut_V_preg <= ap_const_lv2_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and not((ap_const_lv1_0 = tmp_fu_230_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_fu_230_p2))) then 
                    iterations_ap_vld_preg <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_58))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st10_fsm_9 = ap_CS_fsm) and not((ap_const_lv1_0 = localEmpty_load_load_fu_265_p1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st12_fsm_11 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_5_reg_359))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st12_fsm_11 = ap_CS_fsm) or ((ap_ST_st4_fsm_3 = ap_CS_fsm) and not((localFull_load_load_fu_241_p1 = ap_const_lv1_0))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_ST_st2_fsm_1 = ap_CS_fsm) and not((ap_const_lv1_0 = tmp_fu_230_p2))) or (ap_ST_st6_fsm_5 = ap_CS_fsm))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st4_fsm_3 = ap_CS_fsm) and (localFull_load_load_fu_241_p1 = ap_const_lv1_0))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm , ap_sig_bdd_58 , localFull_load_load_fu_241_p1 , localEmpty_load_load_fu_265_p1 , tmp_fu_230_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if ((ap_const_lv1_0 = tmp_fu_230_p2)) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                else
            ...
            when ap_ST_st4_fsm_3 => 
                if (not((localFull_load_load_fu_241_p1 = ap_const_lv1_0))) then
            ...
            when ap_ST_st10_fsm_9 => 
                if (not((ap_const_lv1_0 = localEmpty_load_load_fu_265_p1))) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
    ...
    ap_done_assign_proc : process(ap_CS_fsm, tmp_fu_230_p2)
    begin
        if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_fu_230_p2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm, tmp_fu_230_p2)
    begin
        if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_fu_230_p2))) then 
    ...
    ap_sig_bdd_58_assign_proc : process(ap_start, iterations_ap_vld_in_sig)
    begin
                ap_sig_bdd_58 <= ((iterations_ap_vld_in_sig = ap_const_logic_0) or (ap_start = ap_const_logic_0));
    end process;


    -- cmdOut_V assign process. --
    cmdOut_V_assign_proc : process(ap_CS_fsm, ap_sig_bdd_58, localFull_load_load_fu_241_p1, localEmpty_load_load_fu_265_p1, tmp_fu_230_p2, cmdOut_V_preg)
    begin
        if (((ap_ST_st9_fsm_8 = ap_CS_fsm) or ((ap_ST_st10_fsm_9 = ap_CS_fsm) and (ap_const_lv1_0 = localEmpty_load_load_fu_265_p1)))) then 
    ...
    currentIteration_assign_proc : process(ap_CS_fsm, j_reg_167, tmp_fu_230_p2, currentIteration_preg)
    begin
        if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and not((ap_const_lv1_0 = tmp_fu_230_p2)))) then 
    ...
    finished_ap_vld_assign_proc : process(ap_CS_fsm, tmp_fu_230_p2)
    begin
        if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_fu_230_p2))) then 
    ...
    grp_read_fu_139_p2 <= (0=>empty, others=>'-');
    i_1_fu_268_p2 <= std_logic_vector(unsigned(op2_assign_reg_190) + unsigned(ap_const_lv32_1));
    i_fu_244_p2 <= std_logic_vector(unsigned(val_assign_reg_179) + unsigned(ap_const_lv32_1));
    ...
    j_1_fu_235_p2 <= std_logic_vector(unsigned(j_reg_167) + unsigned(ap_const_lv32_1));
    localEmpty_load_load_fu_265_p1 <= localEmpty_fu_92;
    localFull_load_load_fu_241_p1 <= localFull_fu_88;

    -- priorityOut_V assign process. --
    priorityOut_V_assign_proc : process(ap_CS_fsm, tmp_2_reg_346, priorityOut_V_preg)
    begin
        if ((ap_ST_st5_fsm_4 = ap_CS_fsm)) then 
    ...
    result_1_fu_288_p2 <= std_logic_vector(unsigned(result_fu_80) + unsigned(tmp_6_fu_284_p1));
    tmp_2_fu_250_p1 <= val_assign_reg_179(8 - 1 downto 0);
    ...
    tmp_6_fu_284_p1 <= std_logic_vector(resize(unsigned(priorityIn_V),32));
    tmp_fu_230_p2 <= "1" when (signed(j_reg_167) < signed(iterations_in_sig)) else "0";

    -- total assign process. --
    total_assign_proc : process(ap_CS_fsm, tmp_fu_230_p2, count_fu_84, total_preg)
    begin
        if (((ap_ST_st2_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = tmp_fu_230_p2))) then 
            total <= count_fu_84;
        else 
