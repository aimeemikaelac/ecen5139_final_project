...
#ifndef _runTest_random_priorities_H_
#define _runTest_random_priorities_H_
...
struct runTest_random_priorities_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(runTest_random_priorities_core);
    runTest_random_priorities_core(sc_core::sc_module_name) {
    ...
    ~runTest_random_priorities_core() {
        delete [] mem;
    }
...
SC_MODULE( runTest_random_priorities )
{
    ...
    SC_CTOR( runTest_random_priorities ) {
        meminst = new runTest_random_priorities_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    runTest_random_priorities_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_runTest_random_priorities_H_
