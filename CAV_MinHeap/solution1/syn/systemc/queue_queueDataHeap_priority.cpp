...
void queue_queueDataHeap_priority::proc_mem_q()
{
...
void queue_queueDataHeap_priority::proc_mem_ra()
{
...
void queue_queueDataHeap_priority::proc_mem_ce()
{
    sc_lv<2> tmp;
    tmp[1] = ce0.read();
    tmp[0] = ce1.read();
...
void queue_queueDataHeap_priority::proc_mem_wa()
{
    sc_lv<2 * AddressWidth> tmp;
    tmp = (address0.read(), address1.read());
    mem_wa.write(tmp);
...
void queue_queueDataHeap_priority::proc_mem_we()
{
    sc_lv<2> tmp;
    tmp[1] = we0.read();
    tmp[0] = we1.read();
...
void queue_queueDataHeap_priority::proc_mem_d()
{
...
void queue_queueDataHeap_priority::proc_op()
{
...
void queue_queueDataHeap_priority::proc_addr()
{
...
// check collision
void queue_queueDataHeap_priority::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
