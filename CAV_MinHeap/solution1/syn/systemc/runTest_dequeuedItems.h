...
#ifndef _runTest_dequeuedItems_H_
#define _runTest_dequeuedItems_H_
...
struct runTest_dequeuedItems_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(runTest_dequeuedItems_core);
    runTest_dequeuedItems_core(sc_core::sc_module_name) {
...
SC_MODULE( runTest_dequeuedItems )
{
    ...
    SC_CTOR( runTest_dequeuedItems ) {
        meminst = new runTest_dequeuedItems_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    runTest_dequeuedItems_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_runTest_dequeuedItems_H_
