...
#ifndef _queue_queueDataHeap_priority_H_
#define _queue_queueDataHeap_priority_H_
...
struct queue_queueDataHeap_priority_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(queue_queueDataHeap_priority_core);
    queue_queueDataHeap_priority_core(sc_core::sc_module_name) {
    ...
    ~queue_queueDataHeap_priority_core() {
        delete [] mem;
    }
...
SC_MODULE( queue_queueDataHeap_priority )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 201;
    ...
    SC_CTOR( queue_queueDataHeap_priority ) {
        meminst = new queue_queueDataHeap_priority_core <2, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    queue_queueDataHeap_priority_core <2, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_queue_queueDataHeap_priority_H_
