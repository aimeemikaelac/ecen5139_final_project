...
entity runTest_random_priorities_rom is 
    generic(
             dwidth     : integer := 9; 
             awidth     : integer := 8; 
...
architecture rtl of runTest_random_priorities_rom is 
...
entity runTest_random_priorities is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of runTest_random_priorities is
    component runTest_random_priorities_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    runTest_random_priorities_rom_U :  component runTest_random_priorities_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
