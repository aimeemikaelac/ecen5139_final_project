...
#ifndef _queue_queueData_priority_H_
#define _queue_queueData_priority_H_
...
struct queue_queueData_priority_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(queue_queueData_priority_core);
    queue_queueData_priority_core(sc_core::sc_module_name) {
...
SC_MODULE( queue_queueData_priority )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 400;
    ...
    SC_CTOR( queue_queueData_priority ) {
        meminst = new queue_queueData_priority_core <2, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    queue_queueData_priority_core <2, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_queue_queueData_priority_H_
