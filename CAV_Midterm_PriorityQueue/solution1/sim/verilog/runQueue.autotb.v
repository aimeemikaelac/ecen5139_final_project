...
`define AUTOTB_DUT      runQueue
`define AUTOTB_DUT_INST AESL_inst_runQueue
`define AUTOTB_TOP      apatb_runQueue_top
`define AUTOTB_LAT_RESULT_FILE "runQueue.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "runQueue.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_runQueue_top
...
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.runQueue.autotvout_ap_return.dat"
